...
def get_up_block(
    ...
    """ attnupblock, crossattnupblock, upblock """
    if with_attn:
        return AttnUpBlock(
            spatial_dims=spatial_dims,
            in_channels=in_channels,
...
class DiffusionModelUNet(nn.Module):
    ...
    def __init__(
            ...
            attention_levels: Sequence[bool] = (False, False, True, True),  # attm level
            norm_num_groups: int = 32,
            norm_eps: float = 1e-6,
            resblock_updown: bool = False,
        ...
        self.conv_in = Convolution(spatial_dims=spatial_dims,  #
                                   ...
                                   out_channels=num_channels[0],  # 64
                                   strides=1,
                                   kernel_size=3,
                                   padding=1,
                                   conv_only=True,
    ...
    def forward(
        ...
        """
        Args:
            x: input tensor (N, C, SpatialDims). # why so small ?
